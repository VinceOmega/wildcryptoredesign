            ...
            <div class="panel-body thin-panel">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-4">
                        ...
                        <div class="col-xs-12 box">WILD{$Syndicate.minimumBuyIn}</div>
                    </div>
                    <div class="col-xs-12 col-sm-4">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="col-xs-12 box">
                            WILD0 <span>{$Top.i18n("Draw__Syndicate__WinningsToDate")}</span>
                        </div>
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="row members-padding">
                    <div class="col-xs-12">
                        <div class="col-xs-12 box member">
                            <span class="inherit right">Stake WILD{$Top.Syndicate.minimumBuyIn}</span>
