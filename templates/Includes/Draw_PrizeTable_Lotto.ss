            ...
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="{$Top.Link}#collapsePrize">
                        ...
                        <span>{$Top.i18n("Draw__Lotto__PrizeTable")}</span>
                    </a>
                </h4>
            </div>
                        ...
                        <div class="inner">
                            <div class="tablebox">
                                <div class="tablebox__header">
                                    <div class="tablebox__cell tablebox__cell--bold tablebox__cell--center">{$Top.i18n("Draw__Lotto__Table__Prize")}</div>
                                    <div class="tablebox__cell tablebox__cell--bold tablebox__cell--center">{$Top.i18n("Draw__Lotto__Table__WinningCombo")}</div>
                                </div>
                                <% loop $Prizes %>
                                    <div class="tablebox__row">
                                        <div class="tablebox__cell tablebox__cell--center">Win $narrative</div>
                                        <div class="tablebox__cell tablebox__cell--center">Match $numberOfMatches <% if requiresBonusBalls %>+ {$Top.i18n("Draw__Lotto__BonusBall")} <% end_if %></div>
                                    </div>
                                <% end_loop %>
                            </div>
                        </div>
