...
<form $FormAttributes class="form" role="form">
    ...
    <h4 class="cmsinput cmsinput--ignore header--block" style="padding-left: 5px;">{$Top.i18n("Repayment__YouHave")} w {$Top.forceDecimal($AvailableBalance)} {$Top.i18n("Repayment__WithdrawnMessage")}</h4>
        ...
        <% with $Fields.dataFieldByName(amount) %>
            <div id="$Name" class="form__fieldbox form__fieldbox--wrap">
                ...
                <div class="form__fieldholder form__fieldholder--small">
                    <span class="currencyinput currencyinput--left">w </span>
                    $Field
